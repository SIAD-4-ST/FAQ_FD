...
Rechercher une réponse à partir d’une question libre
Explorer les questions par thématiques
Afficher une réponse principale ainsi que des questions proches
...
Les données FAQ sont intégrées directement dans le fichier (DEFAULT_FAQ_WRAPPER en JavaScript)
...
Pas de moteur sémantique avancé (type IA)
Maintenance manuelle du contenu
